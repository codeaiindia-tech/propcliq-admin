        ...
        <>
            ...
            <Content>
                ...
                <div className="row g-5 g-xl-8">
                    ...
                    {/* begin::Col */}
                    <div className="col-xl-4">
                        <MixedWidget3 className="card-xl-stretch mb-xl-8" chartColor="danger" chartHeight="250px" />
                    </div>
                    {/* end::Col */}

                    {/* begin::Col */}
                    <div className="col-xl-4">
                        <MixedWidget3 className="card-xl-stretch mb-5 mb-xl-8" chartColor="primary" chartHeight="250px" />
                    </div>
                    {/* end::Col */}
                </div>
                {/* end::Row */}
                ...
                <div className="row g-5 g-xl-8">
                    {/* begin::Col */}
                    <div className="col-xl-4">
                        <MixedWidget6 className="card-xl-stretch mb-xl-8" chartColor="primary" chartHeight="150px" />
                    </div>
                    {/* end::Col */}

                    {/* begin::Col */}
                    <div className="col-xl-4">
                        <MixedWidget6 className="card-xl-stretch mb-xl-8" chartColor="danger" chartHeight="150px" />
                    </div>
                    {/* end::Col */}

                    {/* begin::Col */}
                    <div className="col-xl-4">
                        <MixedWidget6 className="card-xl-stretch mb-5 mb-xl-8" chartColor="success" chartHeight="150px" />
                    </div>
                    {/* end::Col */}
                </div>
                {/* end::Row */}
                ...
                <div className="row g-5 g-xl-8">
                    {/* begin::Col */}
                    <div className="col-xl-4">
                        <MixedWidget7 className="card-xl-stretch mb-xl-8" chartColor="primary" chartHeight="200px" />
                    </div>
                    {/* end::Col */}

                    {/* begin::Col */}
                    <div className="col-xl-4">
                        <MixedWidget7 className="card-xl-stretch mb-xl-8" chartColor="success" chartHeight="200px" />
                    </div>
                    {/* end::Col */}

                    {/* begin::Col */}
                    <div className="col-xl-4">
                        <MixedWidget7 className="card-xl-stretch mb-xl-8" chartColor="danger" chartHeight="200px" />
                    </div>
                    {/* end::Col */}
                </div>
                {/* end::Row */}
                ...
                <div className="row g-5 g-xl-8">
                    {/* begin::Col */}
                    <div className="col-xl-4">
                        <MixedWidget8 className="card-xl-stretch mb-xl-8" chartColor="primary" chartHeight="150px" />
                    </div>
                    {/* end::Col */}

                    {/* begin::Col */}
                    <div className="col-xl-4">
                        <MixedWidget8 className="card-xl-stretch mb-xl-8" chartColor="success" chartHeight="150px" />
                    </div>
                    {/* end::Col */}

                    {/* begin::Col */}
                    <div className="col-xl-4">
                        <MixedWidget8 className="card-xl-stretch mb-5 mb-xl-8" chartColor="danger" chartHeight="150px" />
                    </div>
                    {/* end::Col */}
                </div>
                {/* end::Row */}
                ...
                <div className="row g-5 g-xl-8">
                    {/* begin::Col */}
                    <div className="col-xl-4">
                        <MixedWidget9 className="card-xl-stretch mb-xl-8" chartColor="primary" chartHeight="150px" />
                    </div>
                    {/* end::Col */}

                    {/* begin::Col */}
                    <div className="col-xl-4">
                        <MixedWidget9 className="card-xl-stretch mb-xl-8" chartColor="success" chartHeight="150px" />
                    </div>
                    {/* end::Col */}

                    {/* begin::Col */}
                    <div className="col-xl-4">
                        <MixedWidget9 className="card-xl-stretch mb-xl-8" chartColor="danger" chartHeight="150px" />
                    </div>
                    {/* end::Col */}
                </div>
                {/* end::Row */}
                ...
                <div className="row g-5 g-xl-8">
                    {/* begin::Col */}
                    <div className="col-xl-4">
                        <MixedWidget10 className="card-xl-stretch mb-xl-8" chartColor="info" chartHeight="150px" />
                    </div>
                    {/* end::Col */}
