        ...
        <>
            ...
            <Content>
                ...
                <div className="row g-6 g-xl-9">
                    ...
                    <div className="col-md-6 col-xxl-4">
                        <Card1 color="danger" name="Olivia Wild" job="System Admin" avgEarnings="$14,560" totalEarnings="$236,400" online={true} />
                    </div>
                    <div className="col-md-6 col-xxl-4">
                        <Card1 color="primary" name="Neil Owen" job="Account Manager" avgEarnings="$14,560" totalEarnings="$236,400" online={true} />
                    </div>
                    <div className="col-md-6 col-xxl-4">
                        <Card1
                    ...
                    <div className="col-md-6 col-xxl-4">
                        <Card1 color="danger" name="Emma Bold" job="Corporate Finance" avgEarnings="$14,560" totalEarnings="$236,400" online={true} />
                    </div>
                    <div className="col-md-6 col-xxl-4">
                        <Card1
