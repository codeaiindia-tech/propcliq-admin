    ...
    return (
        <div className="w-100">
            ...
            <div className="fv-row mb-10">
                ...
                <Field name="businessDescriptor" className="form-control form-control-lg form-control-solid" />
                <div className="text-danger mt-2">
            ...
            <div className="fv-row mb-10">
                ...
                <Field as="select" name="businessType" className="form-select form-select-lg form-select-solid">
                    <option></option>
