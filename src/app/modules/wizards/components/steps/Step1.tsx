                    ...
                    {propertyTypeActive === 'Residential' && (
                        <div>
                            ...
                            <div className="add_property-group" style={{ marginTop: '30px' }}>
                                ...
                                {availableFromDateError && <div style={{ color: '#e02727', padding: '10px 0px' }}>{availableFromDateError}</div>}
                            </div>
                            ...
                            {securityDepositActive === 'Custom' && (
                                <div className="add_property-group" style={{ marginTop: '30px' }}>
                                    <TextField required id="standard-basic" label="Security Deposit" variant="standard" className="age_property" />
                                </div>
                            )}
                            <div className="add_property-group" style={{ marginTop: '30px' }}>
                                <div className="label_for_label">
                            ...
                            {lockInPeriodActive === 'Custom' && (
                                <div className="add_property-group" style={{ marginTop: '30px' }}>
                                    <TextField required id="standard-basic" label="Lock in Period" variant="standard" className="age_property" />
                                </div>
                            )}
                            <div className="add_property-group" style={{ marginTop: '30px' }}>
                                <div className="label_for_label">
