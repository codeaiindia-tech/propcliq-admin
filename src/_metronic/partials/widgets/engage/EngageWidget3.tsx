...
const EngageWidget3: FC<Props> = ({ className, color = 'primary' }) => {
    return (
                ...
                <div className="card shadow-none w-auto w-md-300px w-lg-auto w-xxl-300px ml-auto">
                    ...
                    <div className="card-body bg-light px-12 py-10">
                        ...
                        <div className="fs-7 mb-8">
                            Outlines keep you honest. They stop you from indulging in poorly ought out metaphorsy about driving and keep you focused
