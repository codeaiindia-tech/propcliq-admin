            ...
            <div className="card-body d-flex flex-column p-0">
                <div className="d-flex flex-stack flex-grow-1 card-p">
                    <div className="d-flex flex-column me-2">
                        ...
                        <span className="text-muted fw-semibold mt-1" dangerouslySetInnerHTML={{ __html: description }}></span>
                    </div>

                    <span className="symbol symbol-50px">
                        <span className={`symbol-label fs-5 fw-bold bg-light-${color} text-${color}`}>{change}</span>
                    </span>
                </div>
