                    ...
                    >
                        ...
                        <div className="d-flex align-items-center mb-7">
                            ...
                            <div className="d-flex flex-stack flex-grow-1 ms-4 ms-lg-6">
                                ...
                                <div className="d-flex flex-column me-2 me-lg-5">
                                    {/* begin::Title */}
                                    <Link to="/builder" className="text-gray-900 text-hover-primary fw-bold fs-6 fs-lg-4 mb-1">
                                        Layout Builder
                                    </Link>
                                    {/* end::Title */}
                                    {/* begin::Description */}
                                    <div className="text-muted fw-semibold fs-7 fs-lg-6">Dynamically modify and preview layout</div>
                                    {/* end::Description */}
                                </div>
                                {/* end::Wrapper */}
                                <KTIcon iconName="arrow-right" className="text-gray-500 fs-2" />
