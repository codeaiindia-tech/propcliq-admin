                ...
                <form ref={formRef} id="kt_inbox_compose_form" onSubmit={() => console.log('submit')}>
                    ...
                    <div className="d-block">
                        ...
                        <div className="d-flex align-items-center border-bottom inbox-to px-8 min-h-45px">
                            ...
                            <div className="ms-2">
                                <span className="text-muted fw-semibold cursor-pointer text-hover-primary me-2" data-inbox="cc-show">
                                    Cc
                                </span>
                                <span className="text-muted fw-semibold cursor-pointer text-hover-primary" data-inbox="bcc-show">
                                    Bcc
                                </span>
                            </div>
                        </div>
