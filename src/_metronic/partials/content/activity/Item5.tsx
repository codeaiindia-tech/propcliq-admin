                    ...
                    <div className="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-7">
                        <div className="overlay me-10">
                            <div className="overlay-wrapper">
                                <img alt="img" className="rounded w-200px" src={toAbsoluteUrl('media/stock/600x400/img-29.jpg')} />
                            </div>
                        ...
                        <div className="overlay me-10">
                            <div className="overlay-wrapper">
                                <img alt="img" className="rounded w-200px" src={toAbsoluteUrl('media/stock/600x400/img-31.jpg')} />
                            </div>
                        ...
                        <div className="overlay">
                            <div className="overlay-wrapper">
                                <img alt="img" className="rounded w-200px" src={toAbsoluteUrl('media/stock/600x400/img-40.jpg')} />
                            </div>
